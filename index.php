...
<head>
    ...
    <title>Welcome to Best Bank</title>
</head>
<body>
  ...
  <?php require_once './include/header.php' ?>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="https://images.unsplash.com/photo-1565373677928-90e963765eac?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Njh8fGJhbmt8ZW58MHx8MHx8&auto=format&fit=crop&w=2000&q=60" class="d-block w-100 img-fluid"  alt="...">
      ...
      <!-- CArosoul part end -->
        ...
        <div class="container my-5">
            <h1 class="text-dark text-center my-5">Services we provide</h1>
            <div class="container">
